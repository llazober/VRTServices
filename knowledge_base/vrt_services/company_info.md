# VRT Services — Company Overview & Portal Guide
...
- **Primary Support Email:** crm@ostooechei.resend.app
...
4. **Form 8879 IRS E-Signature:** Electronic signature authorization required prior to e-filing federal returns.

## How to Submit Tax Documents
Clients can submit documents through three easy methods:
1. **Direct Email:** Send an email with your document attached to `crm@ostooechei.resend.app`. Include your customer reference tag (e.g. `[Ref: CUST-1001]`) in the subject line.
